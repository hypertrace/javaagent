...
public class ServletInputStreamContextAccessInstrumentationModule extends InstrumentationModule {
  ...
  static class TestAdvice {
    ...
    public static void enter(@Advice.Argument(0) ServletInputStream servletInputStream, @Advice.Argument(1) Metadata metadata) {
      ContextStore<ServletInputStream, Metadata> contextStore = InstrumentationContext
