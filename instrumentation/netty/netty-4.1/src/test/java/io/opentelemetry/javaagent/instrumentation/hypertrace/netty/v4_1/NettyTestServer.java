...
public class NettyTestServer {
  ...
  public int create(List<Class<? extends ChannelHandler>> handlerList) throws IOException, InterruptedException {
        ...
        .childHandler(
            new ChannelInitializer<Channel>() {
              ...
              protected void initChannel(Channel ch) throws Exception {
                ...
                for (Class<? extends ChannelHandler> channelHandlerClass: handlerList) {
